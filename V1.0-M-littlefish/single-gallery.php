<?php
/**
 * The template for Gallery single page
 *
 * @package WordPress
...
get_header(); ?>
    ...
    <a class="to-back" href="<?php echo esc_url( home_url( '/?post_type=gallery' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="Gallery">
        <!--<i class="ti-close"></i>-->
    </a>
